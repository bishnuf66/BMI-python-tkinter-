...
def calculate_bmi():
    try:
        ...
        messagebox.showerror('errror','height cannot be zero!')



titla_label = customtkinter.CTkLabel(app,font=font1,text='BMI calculator',text_color='#fff',bg_color='#000')
titla_label.place(x=20,y=20)
...
height_option_option=customtkinter.CTkComboBox(app,font=font2,text_color='#000',fg_color='#fff',dropdown_hover_color='#06911f',values=height_option,variable=variable2,width=80)
height_option_option.place(x=180,y=180)
height_option_option.set('cm')


calculate_button = customtkinter.CTkButton(app,command= calculate_bmi,font=font2,text_color='#fff',text='calculate BMI',fg_color='#06911f',hover_color='#0611f',bg_color='#000',cursor='hand2',corner_radius=5,width=200)
